...
with open(printFile,'w') as f:
    ...
    f.write("TiempoGenetico1OPX:\t" + str(tiempo_final-tiempo_inicial)+ "\n")
    f.write("CosteGenetico1OPX:\t"+ str(coste( matDist = matrizDistancias, matFlujo = matrizFlujos,perm = first_sol.P)) + "\n")
