...
with open(printFile,'w') as f:
    ...
    f.write("TiempoGenetico2OPXM3:\t" + str(tiempo_final-tiempo_inicial)+ "\n")
    f.write("CosteGenetico2OPXM3:\t"+ str(coste( matDist = matrizDistancias, matFlujo = matrizFlujos,perm = first_sol.P)) + "\n")
