...
\begin{frame}
	...
	\end{itemize}
	En el ejemplo hemos utilizado el primer tipo, siendo la función de distancia de un cluster a otro:\\
	
	\[d(C1,C2) = min\{d(x,y):x	\in C1, y \in C2 \}\]
\end{frame}

\begin{frame}
	\frametitle{Brainstorm optimization. Selección de centros de clusters.}
...
\begin{frame}
	\frametitle{Brainstorm optimization:parámetros de modificación}
...
\begin{frame}
	...
	Ejemplo de ejecución en 2 dimensiones para Rastrigin.
...
\begin{frame}
	...
	\begin{array}{|l|l|l|l|l|l|}
		\hline
		n & m & p_{mutación}& p_{explotación} & p_{clusterCenter} & p_{comb. Centros} \\ \hline
...
\begin{frame}
	...
	\begin{itemize}
		\item La mutación abusa de la aleatoriedad(N(0,1)*random()).
		\item Aplicar las distintas búsquedas locales a pequeña escala en el proceso de mutación.
