...
with open(printFile,'w') as f:
    ...
    f.write("TiempoGenetico2OPX:\t" + str(tiempo_final-tiempo_inicial)+ "\n")
    f.write("CosteGenetico2OPX:\t"+ str(coste( matDist = matrizDistancias, matFlujo = matrizFlujos,perm = first_sol.P)) + "\n")
