...
for i in range(24):
    ...
    solVecina,j = solVecina.busquedaLocal(50000//25)
...
with open(printFile,'w') as f:
    ...
    f.write("TiempoILS:\t" + str(tiempo_final-tiempo_inicial)+ "\n")
    f.write("CosteILS:\t"+ str(coste( matDist = matrizDistancias, matFlujo = matrizFlujos,perm = first_sol.P)) + "\n")
